...
window.T1DAssistant = (function () {
  ...
  const SYSTEM = [
    ...
    "  type 1 diabetes carry 2,043 assertions across 18,560 co-mentioning papers -",
    ...
    "  zero the answer begins with No, even where the two are heavily",
    "  co-mentioned. Type 1 diabetes and Homo sapiens share 55,087 papers and",
    "  carry no assertion at all, because co-mention is not an extracted",
    "  relation and Species is in none of them. Say No, then say what there",
    "  is instead.",
